...
const MESSAGES_PATTERN = './src/translations/extracted/**/*.json'
const LANG_DIR = './src/translations/aggregated/'
const LANG_PATTERN = './src/translations/locales/*.json'

// Try to delete current json files from public/locales
try {
  fs.unlinkSync('./src/translations/aggregated/data.json')
} catch (error) {
  console.log(error)
}
