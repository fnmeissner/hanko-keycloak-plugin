...
public class HankoMultiAuthenticatorFactory implements AuthenticatorFactory, ConfigurableAuthenticatorFactory {
    ...
    public Authenticator create(KeycloakSession session) {
        ...
        return new HankoMultiAuthenticator(userStore, hankoClient);
    }
